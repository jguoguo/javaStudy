...
2.建立applicationContext-action.xml文件，在该文件中必须注入Struts2中Action的依赖对象
	<bean id="addUserAction" class="com.bjpowernode.usermgr.web.action.AddUserAction" scope="prototype">
		<property name="userService" ref="userService"></property>
	</bean>
	！！！必须设置scope=prototype
	
3.struts2.xml配置文件需要修改，<action>标签中的class属性和IoC容器中本次请求对应的Action的id值相同
