						...
						<td>
							<label>
								<input type="text" name="beginDate" size="10" maxlength="10"
									value="<%=new SimpleDateFormat("yyyy-MM-dd").format(fiscalYearPeriod.getBeginDate())%>" readonly="true" onClick="WdatePicker()">
							</label>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="endDate" type="text" id="endDate"
								onClick="WdatePicker()" value="<%=new SimpleDateFormat("yyyy-MM-dd").format(fiscalYearPeriod.getEndDate()) %>" size="10"
