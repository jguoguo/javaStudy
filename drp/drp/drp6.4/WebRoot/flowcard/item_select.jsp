...
<html>
	...
	function doubleClick(itemNo,itemName,spec,pattern,unitName){
		window.opener.document.getElementsByName("itemNo")[<%=index%>].value = itemNo;
		window.opener.document.getElementsByName("itemName")[<%=index%>].value = itemName;
		window.opener.document.getElementsByName("spec")[<%=index%>].value = spec;
		window.opener.document.getElementsByName("pattern")[<%=index%>].value = pattern;
		window.opener.document.getElementsByName("unit")[<%=index%>].value = unitName;
		window.close();
	}
	function selectOk() {
		window.close();
