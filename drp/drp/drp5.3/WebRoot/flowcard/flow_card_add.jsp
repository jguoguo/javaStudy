...
<html>
    ...
    function selectAimClient(obj) {
		window.open('<%=basePath%>flowcard/aim_client_select.jsp?index=' + obj.attributes['index'].nodeValue, "请选择需方客户", "width=700, height=400, scrollbars=no");
    }   
     
    function selectItem(obj) {
		window.open('<%=basePath%>flowcard/item_select.jsp?index=' + obj.attributes['index'].nodeValue, "请选择物料", "width=700, height=400, scrollbars=no");
    } 
