...
<html>
	...
	function uploadPic4Item() {
		window.self.location = "basedata/item_upload.html";
	}
</script>
	</head>
		...
		<form name="itemForm" action="servlet/item/SearchItemServlet">
			...
			<table width="95%" border="1" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td class="rd8">
						<a style="cursor:hand;" onClick="window.open('item_detail.html', '物料详细信息', 'width=400, height=400, scrollbars=no') "><%=item.getItemNo() %></a>
