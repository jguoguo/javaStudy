...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript" src="${pageContext.request.contextPath}/script/WdatePicker.js"></script>
		...
		<script type="text/javascript">
			...
			function topPage() {
				window.self.location ="${pageContext.request.contextPath}/servlet/flowCard/FlowCardServlet?command=${query}&pageNo=${pageModel.topPageNo}&clientId=${param.clientId}&clientName=${param.clientName}&beginDate=${param.beginDate}&endDate=${param.endDate}"
			}
			
			function previousPage() {
				window.self.location ="${pageContext.request.contextPath}/servlet/flowCard/FlowCardServlet?command=${query}&pageNo=${pageModel.previousPageNo}&clientId=${param.clientId}&clientName=${param.clientName}&beginDate=${param.beginDate}&endDate=${param.endDate}"
			}
			
			function nextPage() {
				window.self.location ="${pageContext.request.contextPath}/servlet/flowCard/FlowCardServlet?command=${query}&pageNo=${pageModel.nextPageNo}&clientId=${param.clientId}&clientName=${param.clientName}&beginDate=${param.beginDate}&endDate=${param.endDate}"
			}
			
			function bottomPage() {
				window.self.location ="${pageContext.request.contextPath}/servlet/flowCard/FlowCardServlet?command=${query}&pageNo=${pageModel.bottomPageNo}&clientId=${param.clientId}&clientName=${param.clientName}&beginDate=${param.beginDate}&endDate=${param.endDate}"
			}
			
			function queryFlowCard() {
				window.self.location = "${pageContext.request.contextPath}/servlet/flowCard/FlowCardServlet?command=${query}";
			}
	...
	<body class="body1">
		<form name="flowCardForm" method="post" action="${pageContext.request.contextPath}/servlet/flowCard/FlowCardServlet">
				...
				<table width="95%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td width="522" class="p1" height="2" nowrap>
							<img src="${pageContext.request.contextPath}/images/mark_arrow_02.gif" width="14" height="14">
							&nbsp;
							<b>分销商库存管理&gt;&gt;流向单维护</b>
						</td>
					</tr>
							...
							<c:forEach items="${pageModel.list }" var="flowCard">
								<tr>
									...
									<td width="88" class="rd8">
										<a style="cursor:hand;"
											onClick="window.open('${pageContext.request.contextPath}/servlet/flowCard/FlowCardServlet?command=${detail}', '流向单详细信息', 'width=800, height=400, scrollbars=no')">
